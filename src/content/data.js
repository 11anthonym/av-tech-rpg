...
window.GAME_CONTENT = {
  ...
  jobFamilies: {
    install: {
      ...
      workPattern: "Load, carry, assemble, verify, close out.",
    ...
    service: {
      ...
      workPattern: "Read history, inspect symptoms, verify signal path, choose speed or root cause.",
    ...
    survey: {
      ...
      workPattern: "Inspect constraints, compare against quote, write the problem before install day.",
    ...
    commissioning: {
      ...
      workPattern: "Test the room, find incomplete work, choose the closeout standard.",
    ...
    logistics: {
      ...
      workPattern: "Find, stage, move, label, or route around missing prep.",
    ...
    handoff: {
      ...
      workPattern: "Learn what the client actually needs, translate the system, and leave usable instructions.",
  ...
  tutorial: {
    ...
    installPressures: [
      {
        id: "cable-bag-mismatch",
        label: "Cable bag mismatch",
        revealedSummary: "The accessory bag has two cables with room labels that do not match the carts. It is small enough to ignore and annoying enough to remember.",
        checkModifiers: {
          "cart-2-display": { difficulty: 1, energy: 1 },
        },
        carefulOption: {
          id: "sort-labels",
        ...
        quickOption: {
          id: "match-by-memory",
          label: "Match cables by memory",
          detail: "Fast field judgment might keep the schedule moving, but a bad guess will show up when the cart is tested.",
          result: "The cable match holds after a quick check.",
          log: "Matched the cart cables by memory and the signal held during the room test.",
          energyCost: 1,
          incidentChance: 0.3,
          incidentResult: "The cart drops signal during the quick test. The client sees the screen blink before you catch it.",
          incidentLog: "Immediate first-day pressure: the second cart blinked after a rushed cable match.",
        },
        leaveResult: "Cable label mismatch is left for closeout.",
        closeoutRisk: "A rushed closeout can leave the wrong cable path as the next service mystery.",
      },
      {
        id: "wobbly-caster-kit",
        label: "Wobbly caster kit",
        revealedSummary: "One caster kit fits, but not with the confidence promised by the parts bag. The cart rolls; the question is whether it should.",
        checkModifiers: {
          "cart-2-frame": { difficulty: 1, energy: 1 },
        },
        carefulOption: {
          id: "square-caster",
        ...
        quickOption: {
          id: "snug-caster-fast",
          label: "Snug the caster fast",
          detail: "A fast hardware pass saves time if the wobble is smaller than it looks.",
          result: "The caster holds after a quick hardware pass.",
          log: "Snugged the wobbly caster hardware quickly and it held under test.",
          energyCost: 1,
          incidentChance: 0.35,
          incidentResult: "The cart wobbles during the final roll test. Nothing falls, but the client notices the wobble.",
          incidentLog: "Immediate first-day pressure: the second cart wobbled after a rushed caster pass.",
        },
        leaveResult: "Wobbly caster pressure is left for closeout.",
        closeoutRisk: "A rushed closeout can leave a physical cart problem for a future return trip.",
      },
    ],
  ...
  serviceDispatch: {
    ...
    appointment: {
      ...
      actionMinutes: {
        ...
        "incident-document": 10,
        "install-item": 25,
        "verification-full": 25,
        "verification-quick": 8,
        "verification-skip": 2,
        "client-closeout": 10,
      },
      repairMinutes: {
      ...
      choices: [
        {
          ...
          detail: "Prove the installed display across the room path. This takes the most time but can expose a weak diagnosis before the client inherits it.",
        },
        {
          id: "quick",
          label: "Run a quick confidence check",
          detail: "Test the visible path and handoff sooner. A weak diagnosis may show itself while the client is still waiting.",
        },
        {
          id: "skip",
          label: "Hand the room back unverified",
          detail: "Protect the schedule now and knowingly leave the next visit with the uncertainty you did not test.",
        },
      ],
      quickIncident: {
        baseChance: 0.15,
        rushedApproachPenalty: 0.2,
        strainedInstallPenalty: 0.15,
        tightSchedulePenalty: 0.1,
        lateSchedulePenalty: 0.2,
        evidenceReduction: 0.1,
        result: "The display drops during the confidence check. The installed hardware is present, but the diagnosis is not strong enough for an honest handoff.",
        log: "Final confidence check exposed a dropout before client closeout.",
      },
    },
    diagnosticEvidence: [
      {
    ...
    checks: [
      ...
      },
      {
        ...
        label: "Prove the repaired room",
        type: "post-repair verification",
        skillId: "troubleshooting",
        difficulty: 3,
        contextId: "service-final-verification",
        energyCost: 4,
        requiredTool: "room access",
        optionalTool: "toolBag",
        riskFlag: "serviceFinalVerificationWeak",
        riskLabel: "weak final verification",
        successText: "The repaired room survives a full source, path, and display test before client handoff.",
        strainedText: "The final test exposes a dropout while the technician can still recover or document it.",
        log: "the repaired room is tested across the final signal path",
        detail: "The replacement display is installed. The remaining question is whether the room is fixed or only looks fixed from the credenza.",
      },
    ],
    swapItems: [
  ...
  warehouseDispatch: {
    ...
    checks: [
      ...
      {
        id: "returns",
        label: "Secret Squirrel Shelf",
        type: "returns search",
        skillId: "fieldcraft",
        difficulty: 4,
        contextId: "warehouse-search",
        energyCost: 2,
        requiredTool: "mystery shelf access",
        optionalTool: "labeler",
        riskFlag: "warehouseSearchStrained",
        riskLabel: "Secret Squirrel mystery shelf",
        successText: "Secret Squirrel shelf gives up the correct power supply and makes the mystery-return problem visible.",
        strainedText: "Correct power supply is found, but the mystery shelf makes the next search worse unless closeout fixes the label.",
        log: "the matching power supply is beneath a box labeled HDMI EXTENDERS / DO NOT STOCK / RETURN?",
        detail: "The correct power supply is on the mystery-return shelf everyone calls Secret Squirrel, beneath a box labeled HDMI EXTENDERS / DO NOT STOCK / RETURN? The question mark appears to be the current inventory process.",
      },
    ],
  },
  ...
  scenes: {
    shop: {
      ...
      decor: [
        ...
        { type: "shelf", x: 500, y: 355, w: 160, h: 92, text: "SECRET SQUIRREL", solid: true },
