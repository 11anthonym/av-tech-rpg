...
window.GAME_CONTENT = {
  ...
  world: {
    ...
    portals: {
      garageToLobby: { id: "garageToLobby", fromAreaId: "centerCityGarage", toAreaId: "centerCityLobby", kind: "buildingEntrance", label: "Client entrance" },
      lobbyToConferenceRoom: { id: "lobbyToConferenceRoom", fromAreaId: "centerCityLobby", toAreaId: "centerCityConferenceRoom", kind: "elevator", label: "Client floor elevator" },
